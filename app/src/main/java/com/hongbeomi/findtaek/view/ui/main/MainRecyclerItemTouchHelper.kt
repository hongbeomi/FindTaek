...
class MainRecyclerItemTouchHelper(
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        viewHolder?.let { v ->
            (v as MainRecyclerAdapter.ViewHolder).viewForeground.let {
    ...
    ) = (viewHolder as MainRecyclerAdapter.ViewHolder).viewForeground.let {
    ...
    override fun onChildDraw(
        ...
        val foregroundView = (viewHolder as MainRecyclerAdapter.ViewHolder).viewForeground
